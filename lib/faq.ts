...
export const FAQ_ITEMS: FaqItem[] = [
  {
    ...
    closing:
      'オーガニック検索対策（SEO・MEO）が「検索やマップで見つけてもらう」ための施策であるのに対し、AI検索対策は「AIが正しく理解し、比較・推薦できる状態」を確認・改善する視点を加えます。どちらも店舗集客の重要な基盤です。',
  },
  {
    question: 'オーガニック検索対策とは何ですか？',
    lead:
      'オーガニック検索対策とは、広告費をかけずにGoogle検索やGoogleマップで店舗を見つけてもらうための取り組みです。SEO（検索エンジン最適化）とMEO（マップエンジン最適化）を含みます。',
    bullets: [
      'Google検索での表示・順位改善（SEO）',
      'Googleマップ・GBPの最適化（MEO）',
      '公式サイト・ローカルコンテンツの整備',
      '地域キーワード・店舗名検索への対応',
      '口コミ獲得・構造化データ（Schema）',
    ],
    closing:
      '地域で店舗を探すユーザーに、自然検索経由で発見されやすくすることを目的とします。Local GEO™では、オーガニック検索対策もAI検索対策と一体で支援します。',
  },
  {
    question: 'オーガニック検索対策とAI検索対策の違いは何ですか？',
    lead:
      'オーガニック検索対策（SEO・MEO）は、Google検索やGoogleマップで店舗を「見つけてもらう」ための施策です。AI検索対策では、AIが情報を正しく理解し、比較・推薦できる状態も確認します。',
    bullets: [
      'オーガニック検索（SEO / MEO）：Google検索・マップ順位・GBP・口コミ・公式サイトなど',
      'AI検索対策：FAQ構造化・エンティティ強化・AI引用設計など',
    ],
    closing:
      'Local GEO™は、オーガニック検索対策とAI検索対策の両方を統合して支援します。SEO・MEOは依然として重要な基盤です。',
  },
  {
  ...
  },
  {
    ...
    closing:
      '従来のオーガニック検索対策（SEO・MEO）に加え、AI検索時代の店舗集客を支援する月額60,000円の改善サービスです。',
  },
  {
  ...
  },
  {
    ...
    lead:
      'Googleマップ集客（MEO）は、地域検索で店舗を見つけてもらうオーガニック検索の入口です。AI検索対策は、ChatGPTなどで店舗が比較・推薦される新しい導線への対応です。',
    bullets: [
      'オーガニック検索（Google / マップ）：発見・来店検索の入口',
      'AI検索：比較・おすすめ検索の入口',
    ],
    closing:
  ...
  },
  {
    ...
    lead:
      'Full Protocol Plan（オーガニック検索・AI検索対策を含む契約・運用・レポート込み）の料金は以下の通りです。',
    bullets: [
  ...
  {
    question: 'オーガニック検索対策やAI検索対策は自分でもできますか？',
    lead:
      'GBPの基本情報更新や口コミ返信、公式サイトの更新など、基本的な情報メンテナンスは店舗側でも可能です。一方、',
    bullets: [
      'オーガニック検索（SEO・MEO）とAI検索の横断的な情報設計',
      'FAQ構造化・スキーママークアップ',
      'AI露出の継続モニタリング',
    ],
    closing:
  ...
  {
    question: 'SEO・MEO対策会社を選ぶポイントは？',
    lead:
      'SEO・MEO・オーガニック検索対策の支援会社を選ぶ際は、以下の点を確認することをおすすめします。',
    bullets: [
